...
<div class="wrap">
	...
	<div id="content">
		...
		<div id="main">
			...
			<div class="full_w">
				<div class="h_title">Campaign Toevoegen</div>
				<?php
			if(isset($_POST['caption']) && isset($_POST['descr']) && isset($_POST['Image']) && isset($_POST['url']))
			{
				echo $management->PlaceCampaign($_POST['caption'], $_POST['descr'], $_POST['url'], $_POST['Image']);
			}
			?>
				<form action="" method="post">
					<div class="element">
						<label for="name">Titel </label>
						<input id="name" name="caption" class="text" />
					</div>
					
					<div class="element">
						<label for="name">Link </label>
						<input id="name" name="url" class="text" />
					</div>
					...
					<div class="element">
						...
						<select name="Image" class="">
							<?php 
							foreach(glob('../web-gallery/banners/hot/*') as $image)
							{
								$image = str_replace('../web-gallery/banners/hot/', '', $image);
					...
					<div class="element">
						<label for="content">Descriptie <span></span></label>
						<textarea name="descr" class="textarea" rows="10"></textarea>
					</div>
					<div class="entry">
