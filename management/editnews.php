...
if(!isset($_SESSION['housekeeping']) or !isset($_GET['newsid']))
{
	header('Location: /me');
	die();
}
$Article = $core->GetArticle($_GET['newsid']);
?>
...
<div class="wrap">
	...
	<div id="content">
		...
		<div id="main">
			...
			<div class="full_w">
				<div class="h_title">Nieuws Bewerken</div>
				<?php
			if(isset($_POST['Title']) && isset($_POST['ShortStory']) && isset($_POST['Image']) && isset($_POST['LongStory']))
			{
				echo $management->EditNews($_POST['Title'], $_POST['ShortStory'], $_POST['LongStory'], $_SESSION['username'], $_POST['Image']);
			}
			?>
				<form action="" method="post">
					<div class="element">
						<label for="name">Titel </label>
						<input id="name" value="<?php echo $Article['title']; ?>" name="Titel" class="text" />
					</div>
					
					<div class="element">
						<label for="shortstory">ShortStory </label>
						<input id="name" value="<?php echo $Article['shortstory']; ?>" name="ShortStory" class="text" />
					</div>
					...
					<div class="element">
						...
						<textarea name="LongStory" class="textarea" rows="10"><?php echo $Article['longstory']; ?></textarea>
					</div>
					<div class="entry">
