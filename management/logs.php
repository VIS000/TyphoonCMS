...
<div class="wrap">
	...
	<div id="content">
		...
		<div id="main">
			...
			<div class="full_w">
				<div class="h_title">Logs</div>
						<br>
						<center>
						<TEXTAREA cols=70 name=securitylog readOnly rows=18 wrap=off edit='off' width=300>
						<?php echo file_get_contents('../logs/housekeeping.txt'); ?>
						</TEXTAREA></center>
