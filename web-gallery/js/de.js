/* Start custom landing page background */
if (location.pathname == "/") {
   HabboView.add(function() {
      var documentBody = $('landing');
      if (documentBody != null) {
         documentBody.setStyle({backgroundImage:'url(http://images.habbo.com/c_images/DEdating/bg_DEdating_pattern2.gif)'});
      }
   });
}
/* End custom landing page background */
